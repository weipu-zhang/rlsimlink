# https://github.com/danijar/dreamerv3/blob/b65cf81a6fb13625af8722127459283f899a35d9/embodied/envs/dmlab.py
import functools
import re
import zlib
...
class DMLab:
    ...
    def __init__(
        self, level, repeat=4, size=(64, 64), mode="train", actions="popart", episodic=True, text=None, seed=None
    ):
        ...
        self._env = deepmind_lab.Lab(level="contributed/dmlab30/" + level, observations=obs, config=config)
